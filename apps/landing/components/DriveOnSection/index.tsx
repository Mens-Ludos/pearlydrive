...
export const DriveOnSection: React.FC = () => {
    return (
        <Box py='65px' px='62px'>
            <Card height='433px' borderRadius='76px' overflow='hidden' background='#120021'>
                ...
                >
                    <Flex px='100px' height='100%' alignItems='center'>
                        <Flex flexBasis='33%' height='100%' py='106px' flexDirection='column' justifyContent='space-between' style={{ boxSizing: 'border-box' }}>
                            <Flex flexDirection='column'>
                                <Text style={{ height: '77px' }} fontFamily='Ubuntu' size="xxl" fontWeight='700' color='primary.white'>Big Title</Text>
                                <Text fontFamily='Ubuntu' size="lg" fontWeight='700' color='primary.purple'>Join big community</Text>
                            </Flex>
